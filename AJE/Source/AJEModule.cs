...
namespace AJE
{
    public class EngineWrapper
    {
        ...
        public FloatCurve atmosphereCurve
        {
            get
            {
                if (isModuleEngineFX == false)
                    ...
                    return engineFX.atmosphereCurve;
            }
            set
            {
                if (isModuleEngineFX == false)
                    engine.atmosphereCurve = value;
                else
                    engineFX.atmosphereCurve = value;
            }
        }
        ...
        public float heatProduction
        {
            ...
            {
                if (isModuleEngineFX == false)
                    return engine.heatProduction;
                else
                    return engineFX.heatProduction;
            }
            set
            {
                if (isModuleEngineFX == false)
        ...
        public bool useVelocityCurve
        {
            ...
            {
                if (isModuleEngineFX == false)
                    return engine.useVelocityCurve;
                else
                    return engineFX.useVelocityCurve;
            }
            set
            {
                if (isModuleEngineFX == false)
        ...
        public bool useEngineResponseTime
        {
            get
            {
                if (isModuleEngineFX == false)
                    ...
                    return engineFX.useEngineResponseTime;
            }
            set
            {
                if (isModuleEngineFX == false)
...
/*             [KSPField(isPersistant = false, guiActive = true)]
 ...
 //           mach = (float)aje.fsmach;
        ...
        public EngineWrapper GetEngine()
        {
            ...
            mefx = (ModuleEnginesFX)part.Modules["ModuleEnginesFX"];
            me = (ModuleEngines)part.Modules["ModuleEngines"];

            if (mefx)
            {
                e = new EngineWrapper(mefx);
                return e;
            } 
            if (me)
            {
                e = new EngineWrapper(me);
                return e;
            }
            return null;
    ...
    public class AJESolver
    {
        ...
        public double fsmach, alt, ts0, ps0, q0, u0d, u0, a0, rho0, tsout, psout;
